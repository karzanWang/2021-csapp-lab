...
long B[MAXELEMS][MAXELEMS];
/* $end mountainmain */
void init_data(long A[][MAXELEMS], long B[][MAXELEMS], int n);
...
int main()
{
    ...
    init_data(A, B, MAXELEMS); /* Initialize each element in data to 1 */
